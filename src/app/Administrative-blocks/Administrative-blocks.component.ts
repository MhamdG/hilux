...
@Component({
  selector: 'app-Administrative-blocks',
  templateUrl: './Administrative-blocks.component.html',
  styleUrls: ['./Administrative-blocks.component.css']
})
export class AdministrativeBlocksComponent implements OnInit {
  formData: any = {};
  addBlockData: any = {};
  updateBlockData: any = {};
  removeBlockData: any = {};
