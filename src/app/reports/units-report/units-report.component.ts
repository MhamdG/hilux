        ...
        if (typeof $ !== 'undefined' && $.fn.pivotUI) {
            ...
            $(this.pivotContainer.nativeElement).pivotUI(data, {
                ...
                rows: [
                    ...
                    "أخرى",
                    "رقم الأرض",
                    "المساحة الاجمالية المباعة بالمتر",
                    "المساحة المشتركة المباعة بالمتر",
                    "المساحة الصافية المباعة بالمتر",
                    "المساحة الاجمالية الفعلية بالمتر",
                    "المساحة المشتركة الفعلية بالمتر",
                    "المساحة الصافية الفعلية بالمتر",
                    "حالة التسجيل"
                ],
            });
        } else {
