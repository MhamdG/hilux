...
@Component({
  selector: 'app-administrative-complaint',
  templateUrl: './administrative-complaint.component.html',
  styleUrls: ['./administrative-complaint.component.css']
})
export class AdministrativeComplaintComponent implements OnInit {
  formData: any = {};
  addBlockData: any = {};
  updateBlockData: any = {};
  removeBlockData: any = {};
