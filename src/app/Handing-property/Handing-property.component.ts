...
@Component({
  ...
  templateUrl: './Handing-property.component.html',
  styleUrls: ['./Handing-property.component.css']
})

export class HandingPropertyComponent implements OnInit {
  formData: any = {};
  addBlockData: any = {};
  formErrors: any = {};
  ...
  constructor(
    ...
    private ngxSmartModalService2: NgxSmartModalService,
  ...
  openModalFun(){
    this.ngxSmartModalService2.getModal('updateDataModal').open();
  }
  resetAddBlockModal() {
    this.addBlockData = {};
  ...
  searchData(formData: any) {
    ...
    this.pageData =[
      {
        status:1,
        ownerNameAr:"ahmed ar 1",
        ownerNameEn:" ahmed en 1",
        type:"done",
        date:"2023-10-05",
        nameproperty:"falcon a2",
        recivedBy:"falcon company",
        recivedDate:"2023-11-01",
        landId:22,
        projectName:"alcon Towers",
        unitId:55,
        applicationId:"45648979"
      },
      {
        status:2,
        ownerNameAr:"mohamed ar 1",
        ownerNameEn:" mohamed en 1",
        type:"pending",
        date:"2023-10-15",
        nameproperty:"falcon a7",
        recivedBy:"falcon company",
        recivedDate:"2023-11-03",
        landId:22,
        projectName:"alcon Towers",
        unitId:55,
        applicationId:"45648979"
