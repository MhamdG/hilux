...
@Component({
  ...
  templateUrl: './developer-account-management.component.html',
  styleUrls: ['./developer-account-management.component.css']
})
export class DeveloperAccountManagementComponent implements OnInit {
  formData: any = {};
  addBlockData: any = {};
  updateBlockData: any = {};
  removeBlockData: any = {};
